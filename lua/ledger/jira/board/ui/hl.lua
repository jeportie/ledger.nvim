...
local function mix(a, b, s)
  if not a or not b then return a or b or "#808080" end
...
function M.status_hl(name)
  if not name then return "JiraBoardStTodo" end
  local n = name:lower()
  if n:find("progress") or n:find("doing") then return "JiraBoardStProg" end
  if n:find("review")   or n:find("code review") then return "JiraBoardStReview" end
  if n:find("done") or n:find("closed") or n:find("resolved") then return "JiraBoardStDone" end
  if n:find("block") then return "JiraBoardStBlock" end
  return "JiraBoardStTodo"
end

function M.priority_hl(name)
  if not name then return "JiraBoardCardMuted" end
  if name == "Highest" or name == "High" then return "JiraBoardPriHigh" end
  if name == "Medium" then return "JiraBoardPriMed" end
  if name == "Low" or name == "Lowest" then return "JiraBoardPriLow" end
