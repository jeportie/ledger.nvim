...
local function set_keymaps(buf)
  ...
  map("<CR>", function() require("ledger.jira.board.actions").preview_selected() end)
  map("b", function() require("ledger.jira.board.actions").open_selected() end)
  map("y", function() require("ledger.jira.board.actions").yank_selected() end)
  map("R", function() require("ledger.jira.board.actions").refresh() end)
  map("A", function() require("ledger.jira.board.actions").toggle_assignee_filter() end)
  map("B", function() require("ledger.jira.board.actions").toggle_backlog() end)
  map("f", function() require("ledger.jira.board.ui.filter_picker").open() end)
  map("t", function() require("ledger.jira.board.actions").transition_selected() end)
  map("p", function() require("ledger.jira.board.actions").preview_selected() end)
  map("m", function() require("ledger.jira.board.actions").assign_selected_to_me() end)
  map("a", function() require("ledger.jira.board.actions").assign_selected_to_other() end)
  map("u", function() require("ledger.jira.board.actions").unassign_selected() end)
  map("z", function() require("ledger.jira.board.actions").toggle_epic_at_cursor() end)
  map("Z", function() require("ledger.jira.board.actions").toggle_all_epics() end)
  map("?", function() require("ledger.jira.board.actions").show_help() end)
  map("<C-l>", function() M.rerender() end)
  map("<RightMouse>", function() require("ledger.jira.board.ui.menu").open_at_mouse() end)
