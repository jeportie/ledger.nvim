...
for k, v in pairs(STATUS_CP)   do M.STATUS[k]   = nf(v) end
for k, v in pairs(PRIORITY_CP) do M.PRIORITY[k] = nf(v) end
for k, v in pairs(PLATFORM_CP) do M.PLATFORM[k] = nf(v) end
